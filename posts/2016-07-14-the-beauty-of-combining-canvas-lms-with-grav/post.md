...
! For people who do not want to fully _'flip'_ Canvas it is also possible to _'embed'_ a Grav CMS site within their Canvas course site using the surprisingly versatile [Redirect Tool](https://www.eduappcenter.com/apps/63#.WUFlPhPysXo). View a demo of this technique at [https://canvas.sfu.ca/courses/33510/external_tools/5483](https://canvas.sfu.ca/courses/33510/external_tools/5483) using my [Grav CMS ePortfolio Blog package](http://learn.hibbittsdesign.org/eportfolioblog).
