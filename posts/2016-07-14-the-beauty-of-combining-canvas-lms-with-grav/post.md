...
! For people who do not want to fully 'flip' Canvas it is also possible to _nest_ a Grav CMS site within their Canvas course site, the [Redirect Tool](https://www.eduappcenter.com/apps/63#.WUFlPhPysXo) is surprisingly versatile. View a demo of this technique at [https://canvas.sfu.ca/courses/33510/external_tools/5483](https://canvas.sfu.ca/courses/33510/external_tools/5483) using my [Grav CMS ePortfolio Blog package](http://learn.hibbittsdesign.org/eportfolioblog).
