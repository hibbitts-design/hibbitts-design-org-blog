...
Using the above three URL flags it's possible to embed various elements of your Grav Course Hub site into other LMSs like [Canvas](https://canvas.sfu.ca/courses/36662) and <a href="http://paulhibbitts.net/moodle/course/view.php?id=2">Moodle</a>.
